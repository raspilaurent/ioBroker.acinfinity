...
const { 
    ...
    SCHEDULE_EOD_VALUE
    // API_BASE_URL und API_ENDPOINTS wurden entfernt, da sie nicht verwendet werden
} = require('../constants');
                ...
                case 'onSpeed': {
                    ...
                    if (!isNaN(speedValue) && speedValue >= 0 && speedValue <= 10) {
                        ...
                        try {
                            ...
                            require('child_process').exec(cmd, async (error, stdout) => {
                                if (error) {
                ...
                case 'schedule':
                    switch (setting) {
                        case 'startEnabled': {
                            ...
                            currentSettings.schedStartTime = value ? SCHEDULE_MIDNIGHT_VALUE : SCHEDULE_DISABLED_VALUE;
                            break;
                        }
                            
                        case 'endEnabled': {
                            this.adapter.log.debug(`Sende Zeitplan-Ende-Aktivierung an API: deviceId=${deviceId}, portId=${portId}, enabled=${value}`);
                            currentSettings.schedEndtTime = value ? SCHEDULE_EOD_VALUE : SCHEDULE_DISABLED_VALUE;
                            break;
                        }
                        ...
                        case 'startTime': {
                            ...
                            if (startParts.length === 2) {
                                ...
                                currentSettings.schedStartTime = totalMinutes;
                            } else {
                        ...
                        case 'endTime': {
                            ...
                            if (endParts.length === 2) {
                                ...
                                currentSettings.schedEndtTime = totalMinutes;
                            } else {
                                this.adapter.log.warn(`Ungültiges Zeitformat: ${value}`);
                                return;
                            }
        ...
        switch (setting) {
            case 'settingsMode': {
                ...
                if (autoModeIndex >= 0) {
                    ...
                    settings.settingMode = autoModeIndex;
                } else {
            ...
            case 'tempHighTrigger': {
                ...
                settings.devHt = tempHighC;
                settings.devHtf = tempHighF;
                break;
            }
            ...
            case 'tempLowTrigger': {
                ...
                settings.devLt = tempLowC;
                settings.devLtf = tempLowF;
                break;
            }
            ...
            case 'targetTemp': {
                ...
                settings.targetTemp = targetTempC;
                settings.targetTempF = targetTempF;
                break;
            }
        ...
        switch (setting) {
            case 'settingsMode': {
                ...
                if (vpdModeIndex >= 0) {
                    ...
                    settings.vpdSettingMode = vpdModeIndex;
                } else {
            ...
            case 'highTrigger': {
                ...
                settings.activeHtVpdNums = highTriggerValue;
                break;
            }
            ...
            case 'lowTrigger': {
                ...
                settings.activeLtVpdNums = lowTriggerValue;
                break;
            }
            ...
            case 'target': {
                ...
                settings.targetVpd = targetValue;
                break;
            }
